...
Проект получает данные о компаниях и вакансиях с сайта hh.ru и сохраняет их в базе данных PostgreSQL. Также реализован интерфейс для работы с данными
...
```python
from src.api_handler import get_employers, get_vacancies
...
```python
from src.db_setup import create_connection, create_tables, insert_employer, insert_vacancy
